...
# that allow you to select and view photos in a Tk label.
...
label $w.msg -font $font -wraplength 4i -justify left -text "This demonstration allows you to view photos using a Tk \"photo\" image.  First type a directory name in the listbox, then type Return to load the directory into the listbox.  Then double-click on a file name in the listbox to see that image."
pack $w.msg -side top
...
set dirName [file join $tk_demoDirectory photos]
