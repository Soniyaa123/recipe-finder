...
$c create line 1c 5c 7c 5c 7c 7c 9c 7c -width .5c \
	-stipple @[file join $tk_demoDirectory photos gray25.xbm] \
...
$c create arc 6.5c 17c 9.5c 20c -width 4m -style arc \
	...
	-outlinestipple @[file join $tk_demoDirectory photos gray25.xbm]
...
image create photo items.ousterhout \
    -file [file join $tk_demoDirectory photos ouster.png]
image create photo items.ousterhout.active -format "png -alpha 0.5" \
    -file [file join $tk_demoDirectory photos ouster.png]
$c create text 15c 16.2c -text "Bitmaps and photos" -anchor n
