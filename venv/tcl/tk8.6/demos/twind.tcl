...
$t insert end "font settings, and by default contain all the photos "
...
$t insert end "\n\nFinally, photos fit comfortably in text widgets too:"

$t image create end -image \
    [image create photo -file [file join $tk_demoDirectory photos ouster.png]]
