...
class Wm:
    ...
    def wm_iconphoto(self, default=False, *args): # new in Tk 8.5
        ...
        photos passed through args. If default is True, this is applied to
        all future created toplevels as well.

        The data in the photos is taken as a snapshot at the time of
        invocation. If the photos are later changed, this is not reflected
        to the titlebar icons. Multiple photos are accepted to allow
        different photos sizes to be provided. The window manager may scale
        provided icons to an appropriate size.

        On Windows, the photos are packed into a Windows icon structure.
        This will override an icon specified to wm_iconbitmap, and vice
        versa.

        On X, the photos are arranged into the _NET_WM_ICON X property,
...
class Text(Widget, XView, YView):
    ...
    def image_names(self):
        """Return all names of embedded photos in this widget."""
...
class PhotoImage(Image):
    """Widget which can display photos in PGM, PPM, GIF, PNG format."""
...
class BitmapImage(Image):
    """Widget which can display photos in XBM format."""
