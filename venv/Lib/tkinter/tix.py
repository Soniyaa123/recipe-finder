...
class tixCommand:
    ...
    def tix_getimage(self, name):
        ...
        depth of the X display: xbm photos are chosen on monochrome
        displays and color photos are chosen on color displays. By using
...
class TList(TixWidget, XView, YView):
    ...
    two dimensional format and (2) you can use graphical photos as well as
