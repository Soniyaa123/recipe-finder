...
def test_mixed_dynamic_optional_dependencies(tmp_path):
    ...
    """
    files = {
        "requirements-photos.txt": "pillow~=42.0\n  # comment\n",
        "pyproject.toml": cleandoc(
            """
            [project]
            name = "myproj"
            ...
            [tool.setuptools.dynamic.optional-dependencies.photos]
            file = ["requirements-photos.txt"]
    ...
    assert dist.extras_require == {"docs": ["sphinx"], "photos": ["pillow~=42.0"]}
