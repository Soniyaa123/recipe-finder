...
('File','Sequence','N',1,32767,None, None, None, None, 'Sequence with respect to the media photos; order must track cabinet order.',),
...
('Patch','Sequence','N',0,32767,None, None, None, None, 'Primary key, sequence with respect to the media photos; order must track cabinet order.',),
